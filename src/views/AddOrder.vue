...
export default {
  ...
  methods: {
    async sendMutation () {
      ...
      if (this.selectedGarmentType == 'Shirt') {
        measurementsString = `${this.formInputsForShirt.shirtLengthInput} ${this.formInputsForShirt.chestWidthInput} ${this.formInputsForShirt.sleeveLengthInput}`;
      } else {
        measurementsString = `${this.formInputsForPants.pantsLengthInput} ${this.formInputsForPants.waistLengthInput}`;
      }
